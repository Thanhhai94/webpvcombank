...
//     let HUY_DONG_VON_KKH = await dailyServices.getDataFromToDate(arrayInputDate,'TOAN_HANG','TOAN_HANG','QUY_MO_KKH')  
//     let LAI_SUAT_HD_CKH = await dailyServices.getDataFromToDate(arrayInputDate,'TOAN_HANG','TOAN_HANG','LAI_SUAT_CKH')
//     let LAI_SUAT_HD_KKH = await dailyServices.getDataFromToDate(arrayInputDate,'TOAN_HANG','TOAN_HANG','LAI_SUAT_KKH')   
